...
RESOURCES += src/qt/xinard.qrc src/qt/xinard_locale.qrc

TRANSLATIONS += src/qt/locale/xinard_bg.ts \
                src/qt/locale/xinard_de.ts \
                src/qt/locale/xinard_en.ts \
                src/qt/locale/xinard_es.ts \
                src/qt/locale/xinard_fi.ts \
                src/qt/locale/xinard_fr.ts \
                src/qt/locale/xinard_it.ts \
                src/qt/locale/xinard_ja.ts \
                src/qt/locale/xinard_pl.ts \
                src/qt/locale/xinard_pt.ts \
                src/qt/locale/xinard_ru.ts \
                src/qt/locale/xinard_sk.ts \
                src/qt/locale/xinard_sv.ts \
                src/qt/locale/xinard_vi.ts \
                src/qt/locale/xinard_zh_CN.ts \
                src/qt/locale/xinard_zh_TW.ts

...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* XND features */
        {"xinard", "masternode", &masternode, true, true, false},
        {"xinard", "masternodelist", &masternodelist, true, true, false},
        {"xinard", "mnbudget", &mnbudget, true, true, false},
        {"xinard", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"xinard", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"xinard", "mnsync", &mnsync, true, true, false},
        {"xinard", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"xinard", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use xinardd, or the -server option to xinard-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"Xinard Alert\" admin@foo.com\n"),
...
{
    return "> xinard-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:33134/\n";
}

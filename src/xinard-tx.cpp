...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Xinard Core xinard-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  xinard-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xinard transaction") + "\n" +
                               "  xinard-tx [options] -create [commands]   " + _("Create hex-encoded xinard transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded xinard transaction

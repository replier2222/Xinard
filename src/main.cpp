...
#if defined(NDEBUG)
#error "Xinard cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Xinard Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if( nHeight > 1 && nHeight <= 1940 ) {
	        nSubsidy = 1 * COIN;
	}else if( nHeight > 1940 && nHeight <= 3500 ) {
	        nSubsidy = 60 * COIN;
	}else if( nHeight > 3500 && nHeight <= 5000 ) {
	        nSubsidy = 80 * COIN;

                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Xinard-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Xinard address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and xinard: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Xinard Core"), this);
    aboutAction->setStatusTip(tr("Show information about Xinard Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Xinard"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Xinard addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Xinard addresses"));
    ...
    openAction->setStatusTip(tr("Open a Xinard: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Xinard Core help message to get a list with possible Xinard command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Xinard Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Xinard network", "", count));
}
...
{
    QString strTitle = tr("Xinard Core"); // default title

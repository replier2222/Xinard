/* src/config/xinard-config.h.  Generated from xinard-config.h.in by configure.  */
/* src/config/xinard-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://xinard.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Xinard Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Xinard Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "xinard"
